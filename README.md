...
耐心严谨的个性化科研探索导师：用更具体的输入，换可核对的输出。研究领域自由填写，任意非空领域都会进入完整流程，帮你审查想法、生成并修订方案、辅导实验、记录结果，再决定要不要补充验证或开始写。**不代写论文正文，不替你做实验，不编造结果。**
...
研究领域自由填写（如教育研究、临床医学、机械工程），不限定学科；补充验证实验按具体证据缺口定制，不套固定分类模板。不替写代码或论文正文，不解决无关细碎问题，也不替你执行实验。实验结果必须由你亲自记录；负面和不显著的结果会如实保留。

...
- 三栏 desktop、窄屏 drawer/sheet；
- phase timeline、Idea/Plan/Check/Working/Complete panels；
- evidence/document/run trace/export panels；
- server `allowed_commands` 是按钮权限的唯一权威；
- “傲娇”仅用于非实质 microcopy，科研判断保持中性。
